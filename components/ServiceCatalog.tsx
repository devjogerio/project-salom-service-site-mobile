...
export default function ServiceCatalog() {
  ...
  if (loading) {
    return (
      <section
        id="catalogo"
        className="py-16 px-4 bg-gray-50 dark:bg-gray-900 flex justify-center items-center min-h-[400px] transition-colors duration-300"
      >
        <div className="flex flex-col items-center gap-4">
          <Loader2 className="w-10 h-10 text-pink-600 dark:text-pink-400 animate-spin" />
          <p className="text-gray-500 dark:text-gray-400 font-medium">Carregando serviços...</p>
        </div>
      </section>
    );
  }
  ...
  return (
    <section id="catalogo" className="py-8 px-4 bg-gray-50 dark:bg-gray-950 transition-colors duration-300">
      {/* Cabeçalho da seção com Título */}
      <div className="flex flex-col items-center mb-8 text-center px-4">
        <h2 
          className="font-bold font-montserrat text-gray-800 dark:text-white mb-2 transition-colors duration-300"
          style={{ fontSize: 'clamp(1.75rem, 4vw, 2.5rem)' }}
        >
          Nossos Serviços
        </h2>
        <p 
          className="text-gray-500 dark:text-gray-400 max-w-lg mx-auto transition-colors duration-300"
      ...
      <div className="sticky top-0 z-30 bg-gray-50/95 dark:bg-gray-950/95 backdrop-blur-sm py-4 mb-8 -mx-4 px-4 border-b border-gray-100 dark:border-gray-800 md:static md:bg-transparent md:border-none md:p-0 md:mx-0 transition-all duration-300">
      ...
      {filteredServices.length === 0 && (
        <p className="text-center text-gray-500 dark:text-gray-400 py-8 transition-colors duration-300">
